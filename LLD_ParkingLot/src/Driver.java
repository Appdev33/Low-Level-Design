...
public class Driver {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("C:/Users/nirautel/Desktop/Parking.txt"));
        PrintStream out = new PrintStream(new FileOutputStream("C:/Users/nirautel/Desktop/output.txt"));
        System.setOut(out);
        String[] input;
